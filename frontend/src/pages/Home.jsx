    ...
    <div className="min-h-screen bg-fondo">
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 max-w-7xl">
        ...
        <div className="bg-secondary border border-slate-700 rounded-card p-8 sm:p-12 mb-8 sm:mb-12 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-semibold text-textMain mb-2">Bienvenido a Licorería Al Pasito</h1>
          <p className="text-subtext text-sm sm:text-base mb-6">Descubre nuestra selección premium</p>
        ...
        {recomendados.length > 0 && (
          <div className="card mb-8">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl sm:text-2xl font-semibold text-textMain">Productos Destacados</h2>
              {loadingRecomendados && (
            ...
            <div className="p-4 flex flex-col flex-1">
              ...
              <div className="mt-auto">
                <button
                  ...
                  className="w-full py-3 px-4 rounded-card font-medium text-sm transition-all btn-primary"
                >
      ...
      <footer className="mt-12 sm:mt-16 card">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
          <div>
            ...
            <p className="text-xs sm:text-sm text-subtext">Barrio 11 de Noviembre</p>
            <p className="text-xs sm:text-sm text-subtext">Fernando Rodríguez & Vicente Ramon Roca</p>
          </div>
